    ...
    public function getDescription()
    {
        return implode(
            ' ', [
                ...
                'The dephpugger convert commands to dbgp protocol format to make a',
                'developer\'s life easier (like `n` to `step_over -i 1`).',
                'You can send commands in dbgp format using the command',
                '`dbgp(<commandName>)`.',
                "\n\n",
                "Example: dbgp(property_get -i 3 variableName)\n",
                "(string) => My Value\n\n",
                'You can see how to write dbgp commands, you can see in',
